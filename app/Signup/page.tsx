        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
             ...
             <Link href={"/Signin"}><button className="w-[370px] h-[50px] flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 hover:border-2 hover:border-orange-400 ">
